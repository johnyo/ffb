...
\newpage
To further improve the results, a new method must be employed. We turn to PCA.

The results of PCA and PCA Regression in Figure \ref{fig:pca} show that the majority of the variance in our data is explained by the first 4 principle components. Using PCA regression with 10 principle components, following the method outlined in the 'Methods' section, we are able to out-perform the experts at both Yahoo and ESPN by producing a DCG of 1.8132.
