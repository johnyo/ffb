...
which NFL wide receivers will have the best fantasy football season using data available prior to the beginning of the season.
\end{abstract}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[width=4in]{media/dcg_naive.png}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[width=6in]{media/kmeans.png}
